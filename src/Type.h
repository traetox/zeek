...
public:
	...
	const std::vector<zeek::IntrusivePtr<Type>>& Types() const
		{ return types; }
...
public:
	...
	const std::vector<zeek::IntrusivePtr<Type>>& IndexTypes() const
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
	...
	FuncType(zeek::IntrusivePtr<RecordType> args, zeek::IntrusivePtr<Type> yield, ::function_flavor f)
...
#pragma GCC diagnostic pop
	...
	const zeek::IntrusivePtr<zeek::detail::Attr>& GetAttr(zeek::detail::attr_tag a) const
