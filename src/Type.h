...
public:
	...
	const std::vector<TypePtr>& IndexTypes() const
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
	...
	FuncType(RecordTypePtr args, TypePtr yield, ::function_flavor f)
...
#pragma GCC diagnostic pop
	...
	const zeek::detail::AttrPtr& GetAttr(zeek::detail::attr_tag a) const
