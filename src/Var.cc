...
void add_global(
	const zeek::IntrusivePtr<zeek::detail::ID>& id,
	zeek::IntrusivePtr<zeek::Type> t,
	zeek::detail::init_class c, zeek::IntrusivePtr<zeek::detail::Expr> init,
	std::unique_ptr<std::vector<zeek::IntrusivePtr<zeek::detail::Attr>>> attr,
	decl_type dt)
	{
...
zeek::IntrusivePtr<zeek::detail::Stmt> add_local(
	zeek::IntrusivePtr<zeek::detail::ID> id, zeek::IntrusivePtr<zeek::Type> t,
	zeek::detail::init_class c, zeek::IntrusivePtr<zeek::detail::Expr> init,
	std::unique_ptr<std::vector<zeek::IntrusivePtr<zeek::detail::Attr>>> attr,
	decl_type dt)
	{
