...
void ID::SetVal(zeek::IntrusivePtr<Val> v, init_class c)
	{
...
void ID::SetVal(zeek::IntrusivePtr<Expr> ev, init_class c)
	{
...
const zeek::IntrusivePtr<Attr>& ID::GetAttr(attr_tag t) const
	{
